...
--
-- change default tabstop, automatic detection for go gives 8
vim.opt.tabstop = 4
...
-- Enable mouse mode in normal and visual modes
vim.opt.mouse = 'nv'
...
vim.keymap.set('n', '<leader>l', '<cmd>vert split<CR>', { desc = 'Split vertically' })
